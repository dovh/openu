...
def independentPair(a1, a2):
  ...
  for prop in a1.getAdd():
    if a2.isNegEffect(prop): return False

  for prop in a2.getAdd():
    if a1.isNegEffect(prop): return False

  for prop in a1.getDelete():
    if a2.isPosEffect(prop): return False
    if a2.isPreCond(prop): return False

  for prop in a2.getDelete():
    if a1.isPosEffect(prop): return False
    if a1.isPreCond(prop): return False
